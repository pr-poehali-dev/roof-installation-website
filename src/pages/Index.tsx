...
const WORKS = [
  { id: 1, title: "Двускатная кровля из металлочерепицы", area: "280 м²", city: "Подмосковье", color: "#c45a1a" },
  { id: 2, title: "Мансардная кровля с окнами", area: "150 м²", city: "Тверская обл.", color: "#7a3e14" },
  { id: 3, title: "Вальмовая кровля из мягкой черепицы", area: "320 м²", city: "Ленинградская обл.", color: "#e8813a" },
  { id: 4, title: "Плоская кровля с гидроизоляцией", area: "95 м²", city: "Новгород", color: "#3d2008" },
  { id: 5, title: "Полувальмовая крыша коттеджа", area: "410 м²", city: "Московская обл.", color: "#c45a1a" },
  { id: 6, title: "Многоуровневая кровля загородного дома", area: "540 м²", city: "Калужская обл.", color: "#7a3e14" },
];
        ...
        <div className="relative z-10 container mx-auto px-6 py-20">
          <div className="max-w-3xl">
            ...
            <p className="font-body text-lg md:text-xl mb-10 animate-fade-up-delay-3" style={{ color: "rgba(253,246,237,0.85)" }}>
              Профессиональный монтаж, демонтаж и ремонт кровли. Работаем по всей Центральной России. Гарантия 10 лет на все виды работ.
            </p>
