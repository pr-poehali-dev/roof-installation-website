    ...
    >
      <div
        ...
        style={{
          ...
          boxShadow: "0 32px 80px rgba(61,32,8,0.4)",
        }}
      >
        {/* Header */}
        <div
        ...
        >
          ...
          <div
            ...
            style={{ background: "rgba(245,164,97,0.2)" }}
          >
          ...
          {status === "success" ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                >
                  Ваше имя{" "}
                  <span style={{ color: "var(--orange-main)" }}>*</span>
                </label>
                <input
                  required
                  value={name}
                  ...
                  onFocus={(e) => {
                    e.target.style.borderColor = "var(--orange-main)";
                  }}
                  onBlur={(e) => {
                    e.target.style.borderColor = "rgba(196,90,26,0.15)";
                  }}
                />
              </div>
              <div>
              ...
              <div>
                ...
                >
                  Комментарий{" "}
                  <span style={{ color: "#b09080" }}>(необязательно)</span>
                </label>
                <textarea
                  value={message}
              ...
              <button
                ...
                style={{
                  ...
                  color: "white",
                  boxShadow: "0 6px 20px rgba(196,90,26,0.35)",
                }}
              >
  ...
  return (
    <div className="flex gap-0.5">
      {Array.from({ length: 5 }).map((_, i) => (
        <span
          key={i}
          style={{ color: i < count ? "#e8813a" : "#d4c4b0" }}
          className="text-lg"
        >
          ★
        </span>
      ...
      >
        <div className="absolute inset-0">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(135deg, rgba(61,32,8,0.85) 0%, rgba(122,62,20,0.5) 50%, rgba(232,129,58,0.2) 100%)",
            }}
          />
        </div>
          ...
          <div className="max-w-3xl">
            <div className="animate-fade-up-delay-1">
              <span
                ...
                style={{
                  background: "rgba(232,129,58,0.2)",
                  border: "1px solid rgba(232,129,58,0.4)",
                  color: "#f5a461",
                }}
              >
            ...
            <p
              className="font-body text-lg md:text-xl mb-10 animate-fade-up-delay-3"
              style={{ color: "rgba(253,246,237,0.85)" }}
            >
              Профессиональный монтаж, демонтаж и ремонт кровли. Работаем по
              всей Архангельской области. Гарантия 10 лет на все виды работ.
            </p>
            <div className="flex flex-wrap gap-4 animate-fade-up-delay-4">
              <button
                ...
                style={{
                  background: "var(--orange-main)",
                  color: "white",
                  boxShadow: "0 8px 24px rgba(196,90,26,0.4)",
                }}
              >
        ...
        <div
          ...
          style={{
            background: "rgba(61,32,8,0.8)",
            backdropFilter: "blur(10px)",
            borderTop: "1px solid rgba(232,129,58,0.2)",
          }}
        >
        ...
        <div className="container mx-auto">
          <div className="text-center mb-12">
            ...
            <p
              ...
              style={{ color: "#6b4c34" }}
            >
              Полный спектр кровельных работ — от замера до финальной уборки
            </p>
          </div>
            ...
            {[
              {
                icon: "HardHat",
                title: "Монтаж кровли",
                desc: "Устройство новой кровли под ключ. Работаем со всеми видами материалов и формами крыш.",
                price: "от 380 ₽/м²",
              },
              {
                icon: "Wrench",
                title: "Ремонт кровли",
                desc: "Устранение протечек, замена повреждённых элементов, частичный или полный ремонт.",
                price: "от 200 ₽/м²",
              },
              {
                icon: "ArrowUp",
                title: "Демонтаж",
                desc: "Аккуратный демонтаж старого покрытия с вывозом мусора. Подготовка под новую кровлю.",
                price: "от 150 ₽/м²",
              },
              {
                icon: "Thermometer",
                title: "Утепление",
                desc: "Монтаж теплоизоляции кровли и чердачного перекрытия. Экономия на отоплении до 30%.",
                price: "от 250 ₽/м²",
              },
              {
                icon: "Droplets",
                title: "Водостоки",
                desc: "Установка водосточных систем. Металлические и пластиковые системы любых конфигураций.",
                price: "от 450 ₽/п.м.",
              },
              {
                icon: "Shield",
                title: "Гидроизоляция",
                desc: "Устройство надёжной гидроизоляции кровли. Используем материалы ведущих производителей.",
                price: "от 180 ₽/м²",
              },
              ...
              >
                ...
                <span
                  className="font-display font-semibold text-sm px-3 py-1 rounded-lg"
                  style={{
      ...
      >
        <div className="container mx-auto text-center">
          ...
          <p
            ...
            style={{ color: "rgba(253,246,237,0.8)" }}
          >
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          <div>
            <div
              ...
              style={{
                background: "linear-gradient(135deg, #3d2008, #7a3e14)",
              }}
            >
          ...
          <div>
            <h3
              ...
              style={{ color: "var(--brown-dark)" }}
            >
              Кровля Севера — ваш надёжный партнёр
            </h3>
            <p
              className="font-body leading-relaxed mb-4"
              style={{ color: "#6b4c34" }}
            >
              Мы специализируемся на монтаже кровель для частных домов и
              коттеджей. За 5 лет работы мы выполнили более 100 проектов в
              Архангельске, Северодвинске и по всей Архангельской области.
            </p>
            <p
              className="font-body leading-relaxed"
              style={{ color: "#6b4c34" }}
            >
              Наша команда — это профессиональные кровельщики с большим опытом
              работы. Мы используем только проверенные материалы ведущих
          ...
          {[
            {
              ...
              desc: "Мы уверены в качестве наших работ и предоставляем официальную гарантию на каждый выполненный объект.",
            },
            {
              icon: "Clock",
              title: "Точно в срок",
              desc: "Фиксируем сроки в договоре и неукоснительно их соблюдаем. Штрафные санкции за задержку.",
            },
            {
              icon: "FileCheck",
              title: "Честные сметы",
              desc: "Детальная смета до начала работ. Итоговая цена не превышает согласованную без вашего ведома.",
            },
            {
              icon: "Users",
              title: "Своя бригада",
              desc: "Работаем только своими сотрудниками. Никаких случайных субподрядчиков — контроль качества на каждом этапе.",
            },
          ].map(({ icon, title, desc }) => (
            <div
              key={title}
            ...
            {[
              ...
              >
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, var(--orange-main), var(--orange-light))",
                    color: "white",
                  }}
                >
                  {name[0]}
    ...
    <div className="py-16 px-6" style={{ background: "var(--cream)" }}>
      <div className="container mx-auto max-w-5xl">
        <div className="text-center mb-12">
          ...
          <p className="font-body text-lg" style={{ color: "#7a5c45" }}>
            Выполненные объекты за последние 3 года
          </p>
        </div>
        ...
        <div>
          <div className="text-center mb-10">
            ...
            <p className="font-body" style={{ color: "#7a5c45" }}>
              Используемые материалы с описанием и ценами
            </p>
          </div>
      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {REVIEWS.map((r) => (
            ...
            >
              ...
              <p
                className="font-body text-sm leading-relaxed my-4"
                style={{ color: "#5a3e2b" }}
              >
                "{r.text}"
              </p>
        ...
        >
          ...
          <p
            ...
            style={{ color: "rgba(253,246,237,0.8)" }}
          >
            Станьте следующим довольным клиентом — оставьте заявку на бесплатный
            замер
          </p>
          <button
            onClick={onOpenForm}
            className="px-8 py-3 rounded-xl font-display font-semibold hover:scale-105 transition-transform"
            style={{ background: "#f5a461", color: "var(--brown-dark)" }}
          >
            Оставить заявку
          </button>
    ...
    <div className="py-16 px-6" style={{ background: "var(--cream)" }}>
      <div className="container mx-auto max-w-4xl">
        <div className="text-center mb-12">
          ...
          <p className="font-body text-lg" style={{ color: "#7a5c45" }}>
            Примерный расчёт — точную смету предоставим после замера
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            >
              <label
                className="font-display font-semibold text-base block mb-4"
                style={{ color: "var(--brown-dark)" }}
              >
                Площадь дома:{" "}
                <span style={{ color: "var(--orange-main)" }}>{area} м²</span>
              </label>
              <input
                type="range"
                min={40}
                    ...
                    style={
                      roofType === rt.id
                        ? {
                            background: "var(--orange-main)",
                            color: "white",
                            boxShadow: "0 4px 12px rgba(196,90,26,0.3)",
                          }
                        : {
                            background: "rgba(196,90,26,0.06)",
                            color: "#6b4c34",
                            border: "1px solid rgba(196,90,26,0.15)",
                          }
                    }
                  >
                    {rt.label}
                ...
                {Object.keys(MATERIAL_PRICES).map((mat) => (
                  <button
                    ...
                    style={
                      material === mat
                        ...
                        : {
                            background: "rgba(196,90,26,0.04)",
                            color: "#6b4c34",
                            border: "1px solid rgba(196,90,26,0.1)",
                          }
                    }
                  >
                    ...
                    <span className="font-medium">
                      от {MATERIAL_PRICES[mat].toLocaleString()} ₽/м²
                    </span>
                  </button>
                ))}
              </div>
            ...
            >
              ...
              <div className="space-y-3">
                {[
                  {
                    label: "Утепление кровли (+250 ₽/м²)",
                    val: withInsulation,
                    set: setWithInsulation,
                  },
                  {
                    label: "Водосточная система (+450 ₽/п.м.)",
                    val: withGutter,
                    set: setWithGutter,
                  },
                ].map(({ label, val, set }) => (
                    ...
                    <div
                      ...
                      style={{
                        background: val
                          ? "var(--orange-main)"
                          : "rgba(196,90,26,0.1)",
                        border: val ? "none" : "1px solid rgba(196,90,26,0.3)",
                      }}
                    >
                      {val && (
                        <Icon
          ...
          <div>
            <div
              ...
              style={{
                background:
                  "linear-gradient(145deg, var(--brown-dark) 0%, var(--brown-mid) 100%)",
                boxShadow: "0 20px 50px rgba(61,32,8,0.3)",
              }}
            >
                ...
                {withGutter && (
                  ...
                  >
                    <span
                      ...
                      style={{ color: "rgba(253,246,237,0.7)" }}
                    >
                      Водостоки ({gutterPerim} п.м.)
                    </span>
                    <span className="font-display font-semibold text-white">
                      {gutterCost.toLocaleString()} ₽
                    </span>
                  </div>
                )}
              </div>
              ...
              <div
                ...
                style={{
                  background: "rgba(245,164,97,0.15)",
                  border: "1px solid rgba(245,164,97,0.3)",
                }}
              >
                <div
              ...
              <p
                ...
                style={{ color: "rgba(253,246,237,0.5)" }}
              >
                * Расчёт приблизительный. Точная стоимость определяется после
                выезда специалиста и осмотра объекта.
              </p>

              <button
                onClick={onOpenForm}
                className="w-full py-4 rounded-xl font-display font-bold text-lg transition-all hover:scale-105"
                style={{ background: "#f5a461", color: "var(--brown-dark)" }}
              >
    ...
    <div style={{ minHeight: "100vh", background: "var(--cream)" }}>
      ...
      <nav
        ...
        style={{
          ...
          borderBottom: "1px solid rgba(196,90,26,0.12)",
        }}
      >
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-7">
            {TABS.map((t) => (
              <button
                ...
                style={{
                  color:
                    tab === t.id ? "var(--orange-main)" : "var(--brown-dark)",
                }}
              >
                {t.label}
              </button>
          ...
          <div className="hidden md:block">
            <button
              ...
              className="px-5 py-2.5 rounded-xl font-display font-semibold text-sm hover:scale-105 transition-transform"
              style={{ background: "var(--orange-main)", color: "white" }}
            >
              Оставить заявку
            </button>
        ...
        {mobileOpen && (
          <div
            ...
            style={{ borderTop: "1px solid rgba(196,90,26,0.1)" }}
          >
            {TABS.map((t) => (
              <button
                key={t.id}
                ...
                style={{
                  background:
                    tab === t.id ? "rgba(196,90,26,0.1)" : "transparent",
                  color:
                    tab === t.id ? "var(--orange-main)" : "var(--brown-dark)",
                }}
              >
        ...
        <div className="container mx-auto">
          <div className="grid md:grid-cols-3 gap-10 mb-10">
            ...
            <div>
              ...
              >
                <div className="flex items-center gap-2">
                  <Icon name="Phone" size={14} style={{ color: "#f5a461" }} />{" "}
                  +7 (960) 007-99-05
                </div>
                <div className="flex items-center gap-2">
                  <Icon name="Mail" size={14} style={{ color: "#f5a461" }} />{" "}
                  krovlya.severa@gmail.com
                </div>
                <div className="flex items-center gap-2">
          ...
          <div
            className="pt-6 text-center font-body text-xs"
            style={{
